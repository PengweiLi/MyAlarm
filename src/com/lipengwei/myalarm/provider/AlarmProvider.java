...
public class AlarmProvider extends ContentProvider {
    ...
    public Cursor query(Uri uri, String[] projectionIn, String selection, String[] selectionArgs,
        ...
        switch (match) {
            ...
            case ALARMS_ID:
                ...
                break;
            case INSTANCES:
                qb.setTables(AlarmDatabaseHelper.INSTANCES_TABLE_NAME);
                break;
            case INSTANCES_ID:
                qb.setTables(AlarmDatabaseHelper.INSTANCES_TABLE_NAME);
                ...
                break;
            case CITIES:
                qb.setTables(AlarmDatabaseHelper.CITIES_TABLE_NAME);
                break;
            case CITIES_ID:
                qb.setTables(AlarmDatabaseHelper.CITIES_TABLE_NAME);
    ...
    public int update(Uri uri, ContentValues values, String where, String[] whereArgs) {
        ...
        switch (sURLMatcher.match(uri)) {
            ...
            case INSTANCES_ID:
                alarmId = uri.getLastPathSegment();
                count = db.update(AlarmDatabaseHelper.INSTANCES_TABLE_NAME, values,
                        ClockContract.InstancesColumns._ID + "=" + alarmId,
                        null);
                break;
            case CITIES_ID:
                alarmId = uri.getLastPathSegment();
                count = db.update(AlarmDatabaseHelper.CITIES_TABLE_NAME, values,
    ...
    public Uri insert(Uri uri, ContentValues initialValues) {
        ...
        switch (sURLMatcher.match(uri)) {
            case ALARMS:
                ...
                break;
            case INSTANCES:
                rowId = db.insert(AlarmDatabaseHelper.INSTANCES_TABLE_NAME, null, initialValues);
                break;
            case CITIES:
                rowId = db.insert(AlarmDatabaseHelper.CITIES_TABLE_NAME, null, initialValues);
                break;
            default:
    ...
    public int delete(Uri uri, String where, String[] whereArgs) {
        ...
        switch (sURLMatcher.match(uri)) {
            ...
            case ALARMS_ID:
                ...
                break;
            case INSTANCES:
                count = db.delete(AlarmDatabaseHelper.INSTANCES_TABLE_NAME, where, whereArgs);
                break;
            case INSTANCES_ID:
                primaryKey = uri.getLastPathSegment();
                if (TextUtils.isEmpty(where)) {
                ...
                break;
            case CITIES:
                count = db.delete(AlarmDatabaseHelper.CITIES_TABLE_NAME, where, whereArgs);
                break;
            case CITIES_ID:
                primaryKey = uri.getLastPathSegment();
                if (TextUtils.isEmpty(where)) {
